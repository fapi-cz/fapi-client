...
class FapiClientCountriesMockHttpClient extends MockHttpClient
{
	...
	public function __construct()
	{
		$this->add(
			...
			new HttpResponse(
				200,
				array(
					'Date' => array('Sat, 29 Aug 2015 15:09:44 GMT'),
					'Server' => array(
						'Apache/2.2.29 (Unix) DAV/2 PHP/5.6.11 mod_ssl/2.2.29 OpenSSL/0.9.8zg',
					),
					'X-Powered-By' => array('Nette Framework'),
					'Status' => array('200'),
					'Content-Length' => array('4600'),
